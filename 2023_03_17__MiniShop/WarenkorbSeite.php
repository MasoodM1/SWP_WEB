...
<body>
    ...
    <nav>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a class="navlink" href="Laptops.php">Laptops</a>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            $sql = "SELECT a.Bild AS Bild, a.ArtName AS ArtName, u.ID, a.ID AS ID, a.Preis AS Preis, w.Anzahl AS Anzahl FROM warenkorb w JOIN user u ON w.UserID = u.ID JOIN artikel a ON a.ID = w.ArtID WHERE u.ID = ?;";
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<h5>Anzahl:" . $row["Anzahl"] . "</h5>";
                    echo "<form method = 'post' action = 'Delete.php?ArtID=" . $row["ID"] . "'>";
